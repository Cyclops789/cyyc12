...
// window cant be undefined here because we will import the script after the window is loaded 
window.isSm64Loaded = false;
...
Module.canvas = document.getElementById("mario");
...
var wasmBinaryFile = '/assets/sm64.wasm';
if (!isDataURI(wasmBinaryFile)) {
    try {
        wasmBinaryFile = locateFile(wasmBinaryFile);
    } catch (error) {
        throw Error('There was an error importing sm64.warm', error);
    } finally {
        window.isSm64Loaded = true;
    }
}
