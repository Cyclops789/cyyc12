...
function StartMenu({ isStartMenuSticky, setStartMenuSticky }: Props) {
    ...
    return (
        <div
            css={[
                tw`fixed z-[99] border-b border-b-white/25 bottom-[50px] left-0 h-0 w-[656px] rounded-tr opacity-0 bg-primary transition-all ease-in-out duration-200 shadow-md shadow-black`,
